...
<head>
	...
	<script type="text/javascript" src="<?php echo e(URL::asset('js/selectzone.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('js/colorselector.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('js/calendar.php?lang=')); ?>"></script>
</head>
<body>
<h1>
	<span class="action-span"><a href="<?php echo e(URL('goods/list')); ?>">商品列表</a></span>
	<span class="action-span1"><a href="<?php echo e(URL('index/main')); ?>">SHOP 管理中心 </a> </span><span id="search_id" class="action-span1"> - 编辑商品信息 </span>
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/goods/goods_add.blade.php */ ?>