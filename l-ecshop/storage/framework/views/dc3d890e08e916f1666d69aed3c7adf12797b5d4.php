...
<head>
	...
	<script type="text/javascript" src="<?php echo e(URL::asset('js/global.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('js/utils.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('js/transport.js')); ?>"></script>
	<style type="text/css">
		...
		.explode {background: url(<?php echo e(URL::asset('images/menu_minus.gif')); ?>) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(<?php echo e(URL::asset('images/menu_minus.gif')); ?>) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(<?php echo e(URL::asset('images/menu_minus.gif')); ?>) no-repeat 0px 3px; font-weight: normal;}
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="<?php echo e(URL::asset('images/menu_minus.gif')); ?>" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="<?php echo e(URL('goods/list')); ?>" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods/add')); ?>" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('category/list')); ?>" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('comment_manage/list')); ?>" target="main-frame">用户评论</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('brand/list')); ?>" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods_type/list')); ?>" target="main-frame">商品类型</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods/trash')); ?>" target="main-frame">商品回收站</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('picture_batch/list')); ?>" target="main-frame">图片批量处理</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods_batch/add')); ?>" target="main-frame">商品批量上传</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods_export/goods_export')); ?>" target="main-frame">商品批量导出</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods_batch/select')); ?>" target="main-frame">商品批量修改</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('gen_goods_script/setup')); ?>" target="main-frame">生成商品代码</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('tag_manage/list')); ?>" target="main-frame">标签管理</a></li>
						  
						  
						  <li class="menu-item"><a href="<?php echo e(URL('virtual_card/change')); ?>virtual_card.php?act=change" target="main-frame">更改加密串</a></li>
						  <li class="menu-item"><a href="<?php echo e(URL('goods_auto/list')); ?>" target="main-frame">商品自动上下架</a></li>
					</ul>
				</li>
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/admin/menu.blade.php */ ?>