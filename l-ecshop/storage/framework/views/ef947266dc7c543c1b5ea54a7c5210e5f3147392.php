...
<span class="action-span1"><a href="<?php echo e(URL('index/main')); ?>">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 编辑属性 </span>
...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tbody><tr>
        ...
        <td>
          <input type="text" name="attr_name" value="<?php echo e($data->attr_name); ?>" size="30">
    ...
    <input type="hidden" name="attr_id" value="<?php echo e($data->attr_id); ?>">
  </form>
</div>
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/attribute/attribute_edit.blade.php */ ?>