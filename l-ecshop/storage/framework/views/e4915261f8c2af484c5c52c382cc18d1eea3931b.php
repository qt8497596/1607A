...
<div id="header-div">
	<div id="logo-div" style="bgcolor:#000000;">
		<img src="<?php echo e(URL::asset('images/ecshop_logo.gif')); ?>" alt="ECSHOP - power for e-commerce" />
	</div>
	<div id="license-div" style="bgcolor:#000000;"></div>
	<div id="submenu-div">
		<ul>
			  <li><a href="<?php echo e(URL::asset('admin/index')); ?>?act=about_us" target="main-frame">关于本店</a></li>
			  ...
			  <li style="border-left:none;"><a href="<?php echo e(URL::asset('admin/index')); ?>?act=first" target="main-frame">开店向导</a></li>
		</ul>
		<div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
			<a href="<?php echo e(URL::asset('admin/index')); ?>?act=clear_cache" target="main-frame" class="fix-submenu">清除缓存</a>
			<a href="<?php echo e(URL::asset('images/ecshop_logo.gif')); ?>privilege.php?act=logout" target="_top" class="fix-submenu">退出</a>
		</div>
	</div>
</div>
</body>
</html>
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/admin/top.blade.php */ ?>