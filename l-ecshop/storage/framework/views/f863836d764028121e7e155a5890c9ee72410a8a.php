...
<h1>
<span class="action-span"><a href="<?php echo e(URL('goods_type/list')); ?>">商品类型列表</a></span>
  ...
  <form action="update" method="post" name="theForm" onsubmit="return validate();">
    <table cellspacing="1" cellpadding="3" width="100%">
      ...
      <tbody><tr>
        ...
        <td><input type="text" name="cat_name" value=" <?php echo e($data->cat_name); ?> " size="40">
      ...
      <tr style="display:none">
        <td class="label"><a href="javascript:showNotice('noticeAttrGroups');" title="点击此处查看提示信息"><img src="<?php echo e(URL('images/notice.gif')); ?>" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 属性分组:</td>
        <td>
      ...
      <tr align="center">
        <td colspan="2">
          <input type="hidden" name="cat_id" value=" <?php echo e($data->cat_id); ?> ">
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/goods_type/goods_type_edit.blade.php */ ?>