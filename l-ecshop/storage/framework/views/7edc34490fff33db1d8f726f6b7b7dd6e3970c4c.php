...
<h1>
<span class="action-span"><a href="<?php echo e(URL('attribute/list')); ?>">商品属性</a></span>
<span class="action-span1"><a href="<?php echo e(URL('index/main')); ?>">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加属性 </span>
...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          ...
          <option value="0">请选择...</option>
            ...
            <option value="<?php echo e($v->cat_id); ?>"><?php echo e($v->cat_name); ?></option>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeindex');" title="点击此处查看提示信息"><img src="<?php echo e(URL('images/notice.gif')); ?>" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>能否进行检索：</td>
        <td>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeAttrType');" title="点击此处查看提示信息"><img src="<?php echo e(URL('images/notice.gif')); ?>" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>属性是否可选</td>
        <td>
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/attribute/attribute_add.blade.php */ ?>