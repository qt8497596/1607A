...
<body>
<h1>
	<span class="action-span"><a href="<?php echo e(URL('goods/add')); ?>">添加新商品</a></span>
	<span class="action-span1"><a href="<?php echo e(URL('index/main')); ?>">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品列表 </span>
...
<?php /* D:\php2\PHPTutorial\WWW\xiao3\l-ecshop\resources\views/goods/goods_list.blade.php */ ?>